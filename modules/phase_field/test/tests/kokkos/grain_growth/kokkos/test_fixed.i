# Kokkos twin of port/decks/test_fixed.i (P2 fixed-mesh circular-grain gate,
...
# into explicit kernels; the material is KokkosGBEvolution; hypre replaced by gamg with the assembled-matrix
...
[Kernels]
  ...
  []
  [bulk0]
    type = KokkosACGrGrPoly
    variable = gr0
    v = 'gr1'
    mob_name = L
  []
  [int0]
    type = KokkosACInterface
    variable = gr0
    mob_name = L
    kappa_name = kappa_op
    variable_L = true
